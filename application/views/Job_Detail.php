   ...
   <section class="content">
		<div class="box" >
			...
			<div class="box-footer">
			 <a href="<?= base_url()?>Job_controller/add"> <button type="button" class="btn btn-block btn-info" style="width:60px;">Apply</button></a>
			</div>
			<!-- /.box-footer-->
		</div>
...
>>>>>>> f35238096262ede0a3d65a13fe1fd328e5281ffd
</body>
</html>